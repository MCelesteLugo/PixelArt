...
function recorreArreglo (arreglo){
for(var i = 0; i < arreglo.length; i++){
var divColores = document.createElement("div");
divColores.style.backgroundColor= arreglo[i];
divColores.className = "color-paleta";
divColores.addEventListener("click",colorSeleccionado)
